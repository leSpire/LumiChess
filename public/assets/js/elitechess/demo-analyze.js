...
document.getElementById("resetBtn")?.addEventListener("click", () => board.setPosition(START));
document.getElementById("undoBtn")?.addEventListener("click", () => board.setPosition("r3k2r/8/8/3pP3/8/8/4P3/R3K2R w KQkq d6 0 1"));
window.eliteBoard = board;
